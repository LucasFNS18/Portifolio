...
const Skills: React.FC = () => {
  return (
    <div className='text-3xl font-bold mb-2 font-Fonte text-center mt-10'>
      Habilidades
      <div className='container mx-auto px-10 py-8 flex flex-col lg:flex-row items-center justify-between max-w-screen-lg bg-customAzul rounded-xl mt-8'>
        <div className="flex flex-col lg:flex-row items-center justify-between w-full p-6">
          <div className="text-white text-left lg:w-1/2 space-y-4">
            <div className="mt-6">
          ...
          <div className="text-white lg:w-1/2 mt-6 lg:mt-0 space-y-4">
